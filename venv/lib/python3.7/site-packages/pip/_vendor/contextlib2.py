...
class suppress(object):
    """Context manager to suppress specified exceptions.py
...
class ExitStack(object):
    ...
    def push(self, exit):
        ...
        Can suppress exceptions.py the same way __exit__ methods can.
    ...
    def __exit__(self, *exc_details):
        ...
        while self._exit_callbacks:
            ...
            try:
                ...
                # simulate the stack of exceptions.py by setting the context
